...
Data::Data(bool is_train) {
	if (is_train) {
		images = load_mnist_images("D:/UCSP/IA/MLP_ZinjaiProject/train-images.idx3-ubyte", num_images);
		labels = load_mnist_labels("D:/UCSP/IA/MLP_ZinjaiProject/train-labels.idx1-ubyte", num_labels);
	} else {
		images = load_mnist_images("D:/UCSP/IA/MLP_ZinjaiProject/t10k-images.idx3-ubyte", num_images);
		labels = load_mnist_labels("D:/UCSP/IA/MLP_ZinjaiProject/t10k-labels.idx1-ubyte", num_labels);
	}
}
